error id: file://<WORKSPACE>/workflows4s-example/src/main/scala/workflows4s/example/docs/pullrequest/PullRequestWorkflow.scala:`<none>`.
file://<WORKSPACE>/workflows4s-example/src/main/scala/workflows4s/example/docs/pullrequest/PullRequestWorkflow.scala
...
offset: 1364
uri: file://<WORKSPACE>/workflows4s-example/src/main/scala/workflows4s/example/docs/pullrequest/PullRequestWorkflow.scala
text:
```scala
...
object PullRequestWorkflow {
  ...
  object PREvent {
    case class Created(commit: String)          ex@@tends PREvent
